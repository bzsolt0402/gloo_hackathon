 ...
 * with said Hackathon.
 * 
 * This file contains the static class of the Sermon widget.
 */
    ...
    static function make(): void {
        ...
        if (self::$widgetInstance === 0) {
            ...
            echo '<link rel="stylesheet" type="text/css" '
                . 'href="include/widgets/sermon/view/css/index.css">';
            // Include the JS file for the widget
            echo '<script src="include/widgets/sermon/view/js/index.js"></script>';
        }
