 ...
 * with said Hackathon.
 * 
 * This file contains the static class of the YouVersion widget.
 */

namespace WIDGETS;

class YouversionWidget {
    ...
    static function make(): void {
        ...
        if (self::$widgetInstance === 0) {
            ...
            echo '<link rel="stylesheet" type="text/css" '
                . 'href="include/widgets/youversion/view/css/index.css">';
            // Include the JS file for the widget
            echo '<script src="include/widgets/youversion/view/js/index.js"></script>';
        }
